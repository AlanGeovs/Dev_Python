...
resultados = pd.concat([datos['SUM'] ])
...
frecuencias_df.to_csv('frecuencias_sum_numeros.csv', index=False)

print("Los resultados han sido guardados en 'frecuencias_sum_numeros.csv'")
